      ...
      <form onSubmit={handleSubmit} className="dossier-card w-full max-w-sm space-y-4 p-8">
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full border border-paper-dark bg-paper px-3 py-2 font-body outline-none focus:border-blue"
          />
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-blue py-2 font-display uppercase tracking-wide text-paper hover:bg-blue-light disabled:opacity-50"
        >
