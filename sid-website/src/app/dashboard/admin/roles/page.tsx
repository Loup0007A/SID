      ...
      {canRoles && (
        <section className="space-y-4">
          ...
          <form onSubmit={createRole} className="flex gap-2">
            ...
            <button className="bg-blue px-4 font-display text-sm uppercase text-paper hover:bg-blue-light">Créer</button>
          </form>
          ...
          <form onSubmit={assignRoleToUser} className="dossier-card flex flex-wrap items-end gap-3 p-4">
            ...
            <button className="bg-red px-4 py-2 font-display text-sm uppercase text-ink hover:bg-red-light">Attribuer</button>
          </form>
        </section>
      )}
      ...
      {canTeams && (
        <section className="space-y-4">
          ...
          <form onSubmit={createGroup} className="dossier-card flex flex-wrap items-end gap-3 p-4">
            ...
            <button className="bg-blue px-4 py-2 font-display text-sm uppercase text-paper hover:bg-blue-light">Créer</button>
          </form>
