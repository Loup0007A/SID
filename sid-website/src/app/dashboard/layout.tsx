    ...
    <div className="flex min-h-screen bg-ink text-paper">
      <aside className="grain-panel hidden w-64 shrink-0 flex-col border-r border-ink-border p-5 md:flex">
        ...
        <nav className="flex-1 space-y-1">
          ...
          {isSpy && (
            <Link
              href="/dashboard/spy"
              className={clsx(
                "block rounded px-3 py-2 font-mono text-sm uppercase tracking-wide text-red hover:bg-ink-border",
        ...
        <button
          ...
          className="mt-4 border border-paper/20 px-3 py-2 font-mono text-xs uppercase text-paper/70 hover:border-red hover:text-red"
        >
          Se déconnecter
        </button>
      </aside>
      ...
      <div className="flex-1">
        <div className="flex items-center gap-2 border-b border-ink-border p-4 md:hidden">
          {/* eslint-disable-next-line @next/next/no-img-element */}
