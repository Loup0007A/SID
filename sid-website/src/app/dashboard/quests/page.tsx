      ...
      <div className="flex items-center justify-between">
        ...
        {canManage && (
          <button
            ...
            className="bg-red px-4 py-2 font-display text-sm uppercase text-ink hover:bg-red-light"
          >
          ...
          <div key={q.id} className="space-y-2">
            ...
            {!canManage && q.status === "open" && (
              <button
                ...
                className="w-full border border-red py-1 font-mono text-xs uppercase text-red hover:bg-red hover:text-ink"
              >
