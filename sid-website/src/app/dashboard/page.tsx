  ...
  return (
    <div className="space-y-8">
      <div className="dossier-card inline-block px-6 py-4">
        ...
        <p className="font-display text-4xl text-olive">{wallet ? wallet.balance.toLocaleString("fr-FR") : "…"} Cr.</p>
      </div>

      <div>
        <h2 className="mb-4 font-display text-xl uppercase tracking-wide text-brass">Mes missions en cours</h2>
        {myQuests.length === 0 ? (
