...
function ChatInner() {
  ...
  return (
    <div className="flex h-[calc(100dvh-9rem)] gap-4 sm:h-[calc(100dvh-10rem)]">
      <aside className={clsx("w-full shrink-0 space-y-2 overflow-y-auto md:flex md:w-64", activeChannel ? "hidden md:block" : "block")}>
        ...
        {showNew && (
          <div className="glass-card space-y-3 p-3">
            ...
            <p className="border-t border-white/10 pt-2 font-mono text-xs uppercase text-paper/60">Groupe (🕵 espionnable par défaut)</p>
            <input
        ...
        {!activeChannel ? (
          ...
          <>
            <button
              ...
              className="mb-2 flex items-center gap-1 font-mono text-xs uppercase text-paper/60 hover:text-blue-light md:hidden"
            >
