  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="font-display text-2xl uppercase tracking-wide text-brass">Organigramme de la S.I.D.</h1>
        {canManage && (
      ...
      <div className="dossier-card overflow-x-auto p-6">
        ...
        {nodes.length === 0 && <p className="font-body text-paper-text/60">L&apos;organigramme est encore vide.</p>}
      </div>
    </div>
  );
}
