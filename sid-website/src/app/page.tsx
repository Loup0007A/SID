    ...
    <main className="min-h-screen bg-ink text-paper">
      <header className="border-b border-ink-border bg-ink-soft">
        <div className="mx-auto flex max-w-6xl flex-col gap-4 px-6 py-10 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="font-mono text-xs uppercase tracking-[0.3em] text-brass">Dossier public — accès libre</p>
          ...
          <div className="flex gap-3">
            <Link
              href="/login"
              className="border border-paper/40 px-5 py-2 font-display uppercase tracking-wide text-paper hover:bg-paper hover:text-ink"
            >
              Connexion
            </Link>
            <Link
              href="/register"
              className="bg-brass px-5 py-2 font-display uppercase tracking-wide text-ink hover:bg-brass-light"
            >
              Candidater
            </Link>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
        <h2 className="mb-6 font-display text-2xl uppercase tracking-wide text-brass">
