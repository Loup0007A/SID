...
const inputClass =
  "w-full border border-paper-dark bg-paper px-3 py-2 font-body text-ink outline-none focus:border-blue";
      ...
      <main className="flex min-h-screen items-center justify-center bg-ink px-4">
        <div className="dossier-card max-w-md space-y-3 p-8 text-center">
          ...
          <button
            ...
            className="bg-blue px-5 py-2 font-display uppercase text-paper hover:bg-blue-light"
          >
    ...
    <main className="min-h-screen bg-ink px-4 py-12">
      <form onSubmit={handleSubmit} className="dossier-card mx-auto max-w-2xl space-y-5 p-8">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-red py-3 font-display uppercase tracking-wide text-ink hover:bg-red-light disabled:opacity-50"
        >
